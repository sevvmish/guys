...
public class LevelManager : MonoBehaviour
{
    ...
    private IEnumerator playPreview()
    {
        ...
        for (int i = 1; i < previewTransform.Length; i++)
        {
            ...
            for (float ii = 0; ii < (previewTime[i]-0.2f); ii += 0.1f)
            {
    ...
    public static LevelData GetLevelData(LevelTypes level)
    {
        ...
        switch(level)
        {
            ...
            case LevelTypes.level3:
                return new LevelData(Globals.Language.Level6Name, "", GameTypes.Dont_fall, LevelTypes.level3, Globals.Language.Aim_DontFall, "level3", 1, Resources.Load<Sprite>("Sprites/map6"), 2, 5);
            ...
            case LevelTypes.level6:
                return new LevelData(Globals.Language.Level3NewLVLName, "", GameTypes.Dont_fall, LevelTypes.level6, Globals.Language.Aim_DontFall, "level6", 2, Resources.Load<Sprite>("Sprites/map3"), 5, 5);
            ...
            case LevelTypes.level11:
                return new LevelData(Globals.Language.Level11Name, "", GameTypes.Finish_line, LevelTypes.level11, Globals.Language.Aim_Finish, "level11", 3, Resources.Load<Sprite>("Sprites/map11"), 9, 5);

            case LevelTypes.level12:
                return new LevelData(Globals.Language.Level12Name, "", GameTypes.Finish_line, LevelTypes.level12, Globals.Language.Aim_Finish, "level12", 3, Resources.Load<Sprite>("Sprites/map12"), 10, 5);
            ...
            case LevelTypes.level16:
                return new LevelData(Globals.Language.Level16Name, "", GameTypes.Finish_line, LevelTypes.level16, Globals.Language.Aim_Finish, "level16", 2, Resources.Load<Sprite>("Sprites/map16"), 14, 5);

            case LevelTypes.level17:
                return new LevelData(Globals.Language.Level17Name, "", GameTypes.Finish_line, LevelTypes.level17, Globals.Language.Aim_Finish, "level17", 2, Resources.Load<Sprite>("Sprites/map17"), 15, 5);

            case LevelTypes.level18:
                return new LevelData(Globals.Language.Level18Name, "", GameTypes.Dont_fall, LevelTypes.level18, Globals.Language.Aim_DontFall, "level18", 3, Resources.Load<Sprite>("Sprites/map18"), 16, 5);

            case LevelTypes.level19:
                return new LevelData(Globals.Language.Level19Name, "", GameTypes.Finish_line, LevelTypes.level19, Globals.Language.Aim_Finish, "level19", 3, Resources.Load<Sprite>("Sprites/map19"), 17, 5);
        }
